...
# Plot saliency maps:
python saliency_map.py -m SimpleNet -cpp checkpoints/fakes_dataset_SimpleNet_Adam.pt -j out/fakes_dataset_SimpleNet_Adam.json -d fakes_dataset
python saliency_map.py -m XceptionBased -cpp checkpoints/synthetic_dataset_XceptionBased_Adam.pt -j out/synthetic_dataset_XceptionBased_Adam.json -d synthetic_dataset
